...
from trafficbench.visualization.regression import (
...
from trafficbench.visualization.base import VisualizationContext
...
class TestRegressionVisualization:
    ...
    @patch("trafficbench.visualization.regression._load_dataset")
    @patch("trafficbench.visualization.regression._load_regression_data")
    @patch("trafficbench.visualization.regression._create_scatter_plot")
