...
from trafficbench.core.types import (
    ChatUsage,
    DatasetRecord,
    ProfilerConfig,
    Response,
...
from trafficbench.execution.runner import ProfilerRunner, _slugify_model, _stat_summary
from trafficbench.execution.telemetry_session import TelemetrySample
...
class TestProfilerRunner:
    ...
    @patch("trafficbench.execution.runner.DatasetRegistry")
    @patch("trafficbench.execution.runner.ClientRegistry")
    @patch("trafficbench.execution.runner.EnergyMonitorCollector")
    @patch("trafficbench.execution.runner.TelemetrySession")
    @patch("trafficbench.execution.runner.Dataset")
